import{p as U}from"./chunk-K2ZEYYM2-Cr_4jPE1.js";import{p as q}from"./treemap-KMMF4GRG-YVX6V4UE-zVNllnz5.js";import{_ as s,g as Q,s as V,a as Z,b as j,t as H,q as J,l as w,c as K,G as X,aN as Y,aP as ee,aQ as G,aR as te,e as ae,z as re,aS as ie,I as se}from"./md-BcyDgZC_.js";import"./chunk-ZZTYOBSU-C3moydTF.js";import"./index-DJI7bkNU.js";import"./modules/vue-Ga2xr943.js";import"./modules/shiki-BBsL8Z30.js";import"./modules/file-saver-B7oFTzqn.js";import"./default.vue_vue_type_script_setup_true_lang-CV6ohsY4.js";import"./slidev/context-Cf097ZWY.js";import"./layoutHelper-BBDt6ZYb.js";var oe=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,le=structuredClone(oe),ne=s(()=>structuredClone(le),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),P={getConfig:ne,clear:ce,setDiagramTitle:J,getDiagramTitle:H,setAccTitle:j,getAccTitle:Z,setAccDescription:V,getAccDescription:Q,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),me={parse:s(async e=>{const a=await q("pie",e);w.debug(a),fe(a,P)},"parse")},he=s(e=>`
  .pieCircle{
